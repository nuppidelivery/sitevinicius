    ...
    <section ref={containerRef} className="relative min-h-[100svh] flex flex-col justify-end overflow-hidden pt-24 pb-0 bg-background">
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 w-full flex-grow flex flex-col lg:flex-row items-center lg:items-end justify-between mt-4">
        ...
        <div className="w-full lg:w-[55%] flex flex-col items-center lg:items-start text-center lg:text-left mb-8 lg:mb-24 relative z-30">
          ...
          <h1 className="hero-reveal flex flex-col text-center lg:text-left tracking-tight mb-5 leading-[1.1] text-foreground mx-auto lg:mx-0 max-w-full">
            <span className="text-[1.35rem] sm:text-3xl lg:text-[2rem] font-bold mb-1">Quem aparece primeiro para o cliente,</span>
            <span className="text-2xl sm:text-[2.2rem] lg:text-[2.75rem] text-primary font-black">você ou o seu concorrente?</span>
          </h1>
        ...
        <div className="w-full lg:w-[50%] xl:w-[55%] lg:absolute lg:right-[-2%] lg:bottom-0 relative h-[450px] sm:h-[550px] lg:h-[90vh] flex items-end justify-center z-20 mt-8 sm:mt-12 lg:mt-0 pointer-events-none hero-image-reveal">
